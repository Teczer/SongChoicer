      ...
      >
        <div className="w-full max-w-4xl">
          ...
          <p className="mb-4">
            ...
            nous les utilisons et vos droits en tant qu&apos;utilisateur.
          </p>
          <h2 className="text-2xl font-bold mb-2">
            1. Informations que nous collectons
          </h2>
          <p className="mb-4">
            Nous collectons différents types d&apos;informations dans le cadre
            de la fourniture de nos services, y compris :
            <ul className="list-disc list-inside ml-4">
              <li>
                Données d&apos;utilisation : informations sur la manière dont
                vous utilisez notre application.
              </li>
              <li>
                Informations techniques : type d&apos;appareil, système
                d&apos;exploitation, etc.
              </li>
            </ul>
          </p>
          ...
          <p className="mb-4">
            ...
            <ul className="list-disc list-inside ml-4">
              ...
              <li>
                Communiquer avec vous au sujet de mises à jour, offres spéciales
                et autres informations de marketing.
              </li>
              <li>
                Assurer la sécurité de notre application et prévenir les
                fraudes.
              </li>
            </ul>
          </p>
          ...
          <p className="mb-4">
            ...
            <ul className="list-disc list-inside ml-4">
              ...
              <li>
                Avec des prestataires de services qui travaillent en notre nom.
              </li>
            </ul>
          </p>
          <h2 className="text-2xl font-bold mb-2">
          ...
          <p className="mb-4">
            ...
            divulgation, la modification et la destruction.
          </p>
          <h2 className="text-2xl font-bold mb-2">5. Vos droits</h2>
          <p className="mb-4">
            En tant qu&apos;utilisateur, vous avez le droit d&apos;accéder à vos
            informations personnelles, de les corriger, de demander leur
            suppression et de vous opposer à leur traitement. Pour exercer ces
            droits, veuillez nous contacter à l&apos;adresse email fournie
            ci-dessous.
          </p>
          <h2 className="text-2xl font-bold mb-2">
          ...
          <p className="mb-4">
            ...
            l&apos;adresse email suivante : mehdi.hattou1@gmail.com
          </p>
        </div>
        <FooterCopyrights />
      </motion.div>
